...
class DelectClass extends StatefulWidget {
  final String? className;
  final String? classId;
  const DelectClass({super.key, required this.className, required this.classId});

  @override
  State<DelectClass> createState() => _DelectClassState();
}

class _DelectClassState extends State<DelectClass> {
  String? className;
  String? classId;
