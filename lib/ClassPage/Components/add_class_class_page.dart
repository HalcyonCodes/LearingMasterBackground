...
class ClassPageAddClass extends StatefulWidget {
  final String? classId;
  final String? className;
  final String? classStatus;
  final String? classProfile;
  const ClassPageAddClass(
      {super.key,
      this.classId,
      this.className,
      this.classStatus,
  ...
  @override
  State<ClassPageAddClass> createState() => _ClassPageAddClassState();
}

class _ClassPageAddClassState extends State<ClassPageAddClass> {
