...
//课程卡片列表顶部搜索栏
class ConbinationSearch extends StatefulWidget {
  final String? initSearchString;
  const ConbinationSearch({super.key, this.initSearchString});

  @override
  State<ConbinationSearch> createState() => _ConbinationSearchState();
}

class _ConbinationSearchState extends State<ConbinationSearch> {
                ...
                child: Container(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: KString.initInConbinationSearchString,
