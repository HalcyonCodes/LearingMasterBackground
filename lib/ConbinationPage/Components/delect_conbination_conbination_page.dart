...
class DelectConbination extends StatefulWidget {
  final String? conbinationName;
  final String? conbinationId;
  const DelectConbination({super.key, required this.conbinationName, required this.conbinationId});

  @override
  State<DelectConbination> createState() => _DelectConbinationState();
}

class _DelectConbinationState extends State<DelectConbination> {
  String? conbinationName;
  String? conbinationId;

  @override
  void initState() {
    super.initState();
    conbinationName = widget.conbinationName;
